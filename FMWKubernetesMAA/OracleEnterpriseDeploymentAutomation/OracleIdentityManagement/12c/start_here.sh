...
then
      ...
      echo -n  "Do you wish to set the secret for operator install (y/n) : "
      read ANS
      if  check_yes $ANS
      then
   ...
   then
      ...
      echo -n "Enter Password for $WDT_IMAGE_REG_USER account: "
      read -s ANS
      ...
      then
           ...
           then
              ...
              exit
               ...
               if  check_password "UN" $ANS
               then
                 replace_password WDT_IMAGE_REG_PWD $ANS $PWDFILE
               else
                   echo "Password not set"
               fi
           fi
