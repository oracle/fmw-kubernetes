...
java -Djava.security.policy=/u01/oracle/user_projects/workdir/lib/xl.policy -Djava.security.auth.login.config=/u01/oracle/user_projects/workdir/lib/authwl.conf -DAPPSERVER_TYPE=wls -Dweblogic.Name=oim_server1 createAdminUser t3://<OIG_DOMAIN_NAME>-oim-server1.oigns.svc.cluster.local:14000/ <OUD_XELSYSADM_USER> <OUD_USER_PWD> <OIRI_SERVICE_USER> <OIRI_SERVICE_PWD> <OIRI_ENG_USER> <OIRI_ENG_PWD>  <OIRI_ENG_GROUP>
