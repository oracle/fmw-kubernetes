...
cmo.setGroupBaseDN('<OUD_GROUP_SEARCHBASE>')
cmo.setPort(1389)
cmo.setUseRetrievedUserNameAsPrincipal(true)
cmo.setUserBaseDN('<OUD_USER_SEARCHBASE>')
cmo.setPrincipal('cn=<OUD_OIGLDAP_USER>,cn=<OUD_SYSTEMIDS>,<OUD_SEARCHBASE>')
set("Credential",'<OUD_USER_PWD>')
