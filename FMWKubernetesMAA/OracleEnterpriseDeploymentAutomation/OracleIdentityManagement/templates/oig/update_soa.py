...
params = ['<OIG_WEBLOGIC_USER>','<OIG_WEBLOGIC_PWD>','http://<OIG_LBR_INT_HOST>:<OIG_LBR_INT_PORT>/','<OIG_LBR_PROTOCOL>://<OIG_LBR_HOST>:<OIG_LBR_PORT>/','http://<OIG_LBR_INT_HOST>:<OIG_LBR_INT_PORT>/','t3://<OIG_DOMAIN_NAME>-cluster-soa-cluster.<OIGNS>.svc.cluster.local:8001','http://<OIG_LBR_INT_HOST>:<OIG_LBR_INT_PORT>/ucs/messaging/webservice/']
