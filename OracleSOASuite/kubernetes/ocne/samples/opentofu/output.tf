...
output "mount_target_ip" {
  description = "The private IP of the mount target from the module."
  value       = module.oci-file-storage.m_mount_target_ip
}

output "fmw1_fs_ocid" {
  description = "The OCID of the file system created by the module."
  value       = module.oci-file-storage.m_file_system1_ocid
}

output "fmw2_fs_ocid" {
  description = "The OCID of the file system created by the module."
  value       = module.oci-file-storage.m_file_system2_ocid
}

output "fmw1_export_path" {
  description = "The export path of the file system from the module."
  value       = module.oci-file-storage.m_export_path1
}

output "fmw2_export_path" {
  description = "The export path of the file system from the module."
  value       = module.oci-file-storage.m_export_path2
}
