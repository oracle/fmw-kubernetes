...
#
# Description
#  This sample script to configure the OracleSOASuite Domain with custom trust keystore
...
function initialize {
  ...
  if [ ! -f ${createPodInput} ]; then
    validationError "The template file ${createPodInput} for configuring custom keystore to OracleSOASuite domain was not found"
  fi
