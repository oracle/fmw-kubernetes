...
| --- | --- | --- |
| `domainUID` | domainUID of the OracleIdentityGovernance domain. | `governancedomain` |
| `domainNamespace` | Kubernetes namespace of the OracleIdentityGovernance domain. | `oigns` |
