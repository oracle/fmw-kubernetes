...
```
$ ${KUBERNETES_CLI:-kubectl} create -f wcp-domain-domain-pv.yaml
$ ${KUBERNETES_CLI:-kubectl} create -f wcp-domain-domain-pvc.yaml
...
```
$ ${KUBERNETES_CLI:-kubectl} describe pv wcp-domain-domain-pv
Name:            wcp-domain-domain-pv
...
```
$ ${KUBERNETES_CLI:-kubectl} describe pvc wcp-domain-domain-pvc
Name:          wcp-domain-domain-pvc
Namespace:     default
StorageClass:  wcp-domain-domain-storage-class
Status:        Bound
