...
Containers:
  oudsm:
    ...
    Image:          container-registry.oracle.com/middleware/oudsm_cpu:12.2.1.4-jdk8-ol8-<July'24>
...
Events:
  ...
  Normal   Pulled            39m   kubelet            Container image "container-registry.oracle.com/middleware/oudsm_cpu:12.2.1.4-jdk8-ol8-<July'24>" already present on machine
