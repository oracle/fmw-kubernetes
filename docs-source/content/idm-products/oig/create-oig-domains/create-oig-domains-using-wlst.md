...
1. Edit the `create-domain-inputs.yaml` and modify the following parameters. Save the file when complete:   
   ...
   **Note**: Do not edit any other parameters other than ones mentioned below.
   ...
   image: container-registry.oracle.com/middleware/oig_cpu:12.2.1.4-jdk8-ol8-<April'26>
...
generated artifacts:
   ...
   export image="container-registry.oracle.com/middleware/oig_cpu:12.2.1.4-jdk8-ol8-<April'26>"
