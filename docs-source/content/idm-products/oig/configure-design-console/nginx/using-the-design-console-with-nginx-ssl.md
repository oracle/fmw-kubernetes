...
If you haven't already configured an NGINX ingress controller (SSL) for OIG, follow [Using an Ingress with NGINX (SSL)](../../../configure-ingress/nginx/ingress-nginx-setup-for-oig-domain-setup-on-k8s-ssl).
