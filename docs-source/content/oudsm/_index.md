...
This project supports deployment of Oracle Unified Directory Services Manager (OUDSM) Docker images based on the 12cPS4 (12.2.1.4.0) release within a Kubernetes environment. The OUDSM Docker Image refers to binaries for OUDSM Release 12.2.1.4.0.
