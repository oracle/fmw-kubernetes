...
Once the container is running (READY shows as '1/1') check the value of the service port (PORT/s value : here 7001:31674/TCP,7002:31490/TCP)  for the OUDSM service and use this to access OUDSM in a browser:
