...
#
#     NAME
#       deployer.sh - WLS Deploy tool to provision apps and resources.
#
#     DESCRIPTION
...
usage() {
  ...
  echo ""
  echo "        soa_url         - the SOA manged server/cluster URL (used for online deploy)"
  echo ""
...
WLSDEPLOY_PROGRAM_NAME="deployer"; export WLSDEPLOY_PROGRAM_NAME
