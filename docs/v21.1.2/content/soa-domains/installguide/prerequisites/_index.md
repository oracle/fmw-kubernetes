...
For the current production release 21.1.2:
...
* Oracle WebLogic Kubernetes operator 3.1.1 (see [operator releases](https://github.com/oracle/weblogic-kubernetes-operator/releases/tag/v3.1.1) page).
* Oracle SOA Suite 12.2.1.4 Docker image downloaded from My Oracle Support (MOS patch [32398542](https://support.oracle.com/epmos/faces/ui/patch/PatchDetail.jspx?patchId=32398542)). This image contains the latest bundle patch and one-off patches for Oracle SOA Suite.
