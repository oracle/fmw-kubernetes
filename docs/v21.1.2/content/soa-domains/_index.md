...
The current production release for the Oracle SOA Suite domains deployment on Kubernetes is [21.1.2](https://github.com/oracle/fmw-kubernetes/releases). This release uses the Oracle WebLogic Server Kubernetes Operator version [3.1.1](https://github.com/oracle/weblogic-kubernetes-operator/releases/tag/v3.1.1).
