...
1. [Upgrading to April 26 (26.2.1) from April 23 (23.2.1) or later](#upgrading-to-april-26-2621-from-april-23-2321-or-later)
1. [Upgrading to April 26 (26.2.1) from October 22 (22.4.1) or January 23 (23.1.1)](#upgrading-to-april-26-2621-from-october-22-2241-or-january-23-2311)
1. [Upgrading to April 26 (26.2.1) from July 22 (22.3.1)](#upgrading-to-april-26-2621-from-july-22-2231)
1. [Upgrading to April 26 (26.2.1) from releases prior to July 22 (22.3.1)](#upgrading-to-april-26-2621-from-releases-prior-to-july-22-2231)
...
### Upgrading to April 26 (26.2.1) from April 23 (23.2.1) or later

The instructions below are for upgrading from April 23 ([23.2.1](https://github.com/oracle/fmw-kubernetes/releases)) or later to April 26 ([26.2.1](https://github.com/oracle/fmw-kubernetes/releases)).
...
1. Create a `oud-patch-override.yaml` file that contains:
   ...
   image:
     ...
     tag: 12.2.1.4-jdk8-ol8-<April'26>
   imagePullSecrets:
     - name: orclcred
   ```
...
### Upgrading to April 26 (26.2.1) from October 22 (22.4.1) or January 23 (23.1.1)

The instructions below are for upgrading from October 22 ([22.4.1](https://github.com/oracle/fmw-kubernetes/releases)) or April 23 ([23.1.1](https://github.com/oracle/fmw-kubernetes/releases)), to April 26 ([26.2.1](https://github.com/oracle/fmw-kubernetes/releases)).
...
1. Scale down OUD by reducing the replicas to `1`:
   ...
   **Note**: The `$WORKDIR` is the directory for your existing release, not April 26.
...
#### Setup the April 26 code repository to deploy OUD
...
1. Download the latest OUD deployment scripts from the OUD repository:
   ...
   $ git clone https://github.com/oracle/fmw-kubernetes.git --branch release/26.2.1
   ```
...
1. Verify the pods are using the new image by running the following command:
   ...
   ```bash
   ...
   Image:          container-registry.oracle.com/middleware/oud_cpu:12.2.1.4-jdk8-ol8-<April'26>
...
### Upgrading to April 26 (26.2.1) from July 22 (22.3.1)

The instructions below are for upgrading from July 22 ([22.3.1](https://github.com/oracle/fmw-kubernetes/releases)) to April 26 ([26.2.1](https://github.com/oracle/fmw-kubernetes/releases)).

1. Follow [Upgrading to April 26 (26.2.1) from October 22 (22.4.1) or January 23 (23.1.1)](#upgrading-to-april-26-2621-from-october-22-2241-or-january-23-2311) to upgrade the image.
1. Once the image is upgraded, follow [Upgrading Elasticsearch and Kibana](#upgrading-elasticsearch-and-kibana).


### Upgrading to April 26 (26.2.1) from releases prior to July 22 (22.3.1)
...
***Note***: This section should only be followed if upgrading from July 22 (22.3.1) or earlier to April 26 (26.2.1). If you are upgrading from October 22 or later to April 26 do not follow this section.
...
If you are upgrading from July 22 (22.3.1) or earlier, to April 26 (26.2.1), you must first undeploy Elasticsearch and Kibana using the steps below:
