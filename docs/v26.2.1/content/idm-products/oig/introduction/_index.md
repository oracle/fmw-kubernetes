...
The current production release for the Oracle Identity Governance domain deployment on Kubernetes is [26.2.1](https://github.com/oracle/fmw-kubernetes/releases). This release uses the WebLogic Kubernetes Operator version 4.2.10.
...
* [Version 26.1.1](https://oracle.github.io/fmw-kubernetes/26.1.1/idm-products/oig/)
* [Version 25.4.1](https://oracle.github.io/fmw-kubernetes/25.4.1/idm-products/oig/)
* [Version 25.3.1](https://oracle.github.io/fmw-kubernetes/25.3.1/idm-products/oig/)
