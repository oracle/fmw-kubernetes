...
The installation binaries and patches required for release 26.1.2 are:

* JDK:  
    * jdk-8u481-linux-x64.tar.gz
...
* Fusion Middleware Infrastructure patches:
    ...
    * p28186730_1394222_Generic.zip (OPATCH 13.9.4.2.21 FOR EM 13.5/24.1 AND FMW/WLS 12.2.1.4.0, 14.1.1.0.0, 14.1.2.0.0 AND IDM 14.1.2.1)
    * p38807758_122140_Generic.zip (OWSM BUNDLE PATCH 12.2.1.4.251230)
    * p38348152_122140_Generic.zip (ADF BUNDLE PATCH 12.2.1.4.250822)
    * p38792523_122140_Generic.zip (WLS PATCH SET UPDATE 12.2.1.4.251223)
    ...
    * p38716798_122140_Generic.zip (Coherence 12.2.1.4 Cumulative Patch 28 (12.2.1.4.28))
    ...
    * p38633461_122140_Generic.zip (FMWCONTROL BUNDLE PATCH 12.2.1.4.260120)
    ...
    * p38447255_122140_Generic.zip (RDA release 26.1-2026120 for FMW 12.2.1.4.0)
    * p38669934_122140_Generic.zip (JDBC19.29 BUNDLE PATCH 12.2.1.4.251117)
    * p38759265_122140_Generic.zip (FMW Thirdparty Bundle Patch 12.2.1.4.251212)
    * p38665131_122140_Generic.zip (OSS 19C BUNDLE PATCH 12.2.1.4.251117)
    * p34065178_122140_Generic.zip (OVD One Off)

* Oracle SOA Suite and Oracle Service Bus patches

    * p38816461_122140_Generic.zip (SOA Bundle Patch 12.2.1.4.260105)
...
1. Add a JDK package to the WebLogic Image Tool cache:
    ...
    ``` bash
    $ imagetool cache addInstaller --type jdk --version 8u481 --path <download location>/jdk-8u481-linux-x64.tar.gz
    ```
...
1. Add the downloaded product patches to the WebLogic Image Tool cache:  
    ...
    ``` bash   
    $ imagetool cache addEntry --key 38073767_12.2.1.4.0 --value <download location>/38807758_122140_Generic.zip
	
    $ imagetool cache addEntry --key 38348152_12.2.1.4.0 --value <download location>/38348152_122140_Generic.zip
	
	$ imagetool cache addEntry --key 38412437_12.2.1.4.0 --value <download location>/38792523_122140_Generic.zip
	...
	$ imagetool cache addEntry --key 38409281_12.2.1.4.0 --value <download location>/38716798_122140_Generic.zip
	...
	$ imagetool cache addEntry --key 36946553_12.2.1.4.0 --value <download location>/38633461_122140_Generic.zip
	...
	$ imagetool cache addEntry --key 38199225_12.2.1.4.0 --value <download location>/38447255_122140_Generic.zip
	
	$ imagetool cache addEntry --key 37925688_12.2.1.4.0 --value <download location>/38669934_122140_Generic.zip
	
	$ imagetool cache addEntry --key 38405729_12.2.1.4.0 --value <download location>/38759265_122140_Generic.zip
	
	$ imagetool cache addEntry --key 38379810_12.2.1.4.0 --value <download location>/38665131_122140_Generic.zip
	
	$ imagetool cache addEntry --key 34065178_12.2.1.4.0 --value <download location>/34065178_122140_Generic.zip
	
	$ imagetool cache addEntry --key 38253323_12.2.1.4.0 --value <download location>/38816461_122140_Generic.zip
...
1. Append the `--patches` flag and the product patch keys to the `create` command in the `buildArgs` file. The `--patches` list must be a comma-separated collection of patch `--key` values used in the `imagetool cache addEntry` commands above.
   ...
   Sample `--patches` list for the product patches added in to the cache:
      ...
      ```
      --patches 38807758_12.2.1.4.0,38348152_12.2.1.4.0,38792523_12.2.1.4.0,34809489_12.2.1.4.0,36789759_12.2.1.4.0,36316422_12.2.1.4.0,38716798_12.2,1.4.0,37056593_12.2.1.4.0,36426672_12.2.1.4.0,33093748_12.2.1.4.0,38400138_12.2.1.4.0,38633461_12.2.1.4.0,34765492_12.2.1.4.0,34542329_12.2.1.4.0,35965629_12.2.1.4.0,38447255_12.2.1.4.0,38669934_12.2.1.4.0,38759265_12.2.1.4.0,38665131_12.2.1.4.0,34065178_12.2.1.4.0,38816461_12.2.1.4.0,38829855_12.2.1.4.0,33404495_12.2.1.4.0,32827327_12.2.1.4.0,31713053_12.2.1.4.0      
      ```
...
1. Create the Oracle SOA Suite image:
    ...
    COPY --chown=oracle:root jdk-8u481-linux-x64.tar.gz /tmp/imagetool/

    USER oracle


    RUN tar xzf /tmp/imagetool/jdk-8u481-linux-x64.tar.gz -C /u01 \
