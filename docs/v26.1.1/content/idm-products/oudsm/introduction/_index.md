...
The current production release for the Oracle Unified Directory 12c PS4 (12.2.1.4.0) deployment on Kubernetes is [26.1.1](https://github.com/oracle/fmw-kubernetes/releases).
