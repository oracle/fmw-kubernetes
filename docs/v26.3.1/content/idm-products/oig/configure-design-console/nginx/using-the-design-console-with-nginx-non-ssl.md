...
If you haven't already configured an NGINX ingress controller (Non-SSL) for OIG, follow [Using an Ingress with NGINX (non-SSL)](../../../configure-ingress/nginx/ingress-nginx-setup-for-oig-domain-setup-on-k8s).
