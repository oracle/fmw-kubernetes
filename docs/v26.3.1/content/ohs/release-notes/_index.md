...
| Date | Version | Change |
| --- | --- | --- |
| July 2026 | 26.3.1 | Supports Oracle HTTP Server 12.2.1.4 deployment using the July 2026 container image which contains the July Patch Set Update (PSU) and other fixes released with the Critical Patch Update (CPU) program.||
