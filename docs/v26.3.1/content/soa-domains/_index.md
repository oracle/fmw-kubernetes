...
The current production release for the Oracle SOA Suite domains deployment on Kubernetes is [26.3.1](https://github.com/oracle/fmw-kubernetes/releases). This release uses the WebLogic Kubernetes Operator version [4.3.12](https://github.com/oracle/weblogic-kubernetes-operator/releases/tag/v4.3.12).
...
* [Version 26.1.2](https://oracle.github.io/fmw-kubernetes/26.1.2/soa-domains/)
* [Version 25.4.2](https://oracle.github.io/fmw-kubernetes/25.4.2/soa-domains/)
