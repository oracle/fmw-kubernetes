...
1. Download from My Oracle Support:
    - Download patch [38835036](https://support.oracle.com/epmos/faces/ui/patch/PatchDetail.jspx?patchId=38835036) for Oracle Linux 8 based container image from My Oracle Support (MOS).
...
#### Create a Kubernetes secret with domain credentials
  ...
  For more details, see [this document](https://github.com/oracle/weblogic-kubernetes-operator/blob/v4.3.12/kubernetes/samples/scripts/create-weblogic-domain-credentials/README.md).
