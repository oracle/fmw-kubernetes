...
Release 26.3.1 has the following system requirements:

* Kubernetes 1.30.1+, 1.31.1+, 1.32.1+, 1.33.1+, 1.34.1+, 1.35.0+, 1.36.0+ (check with `kubectl version`).
...
* WebLogic Kubernetes Operator 4.3.12 (see the [operator releases 4.3.12](https://github.com/oracle/weblogic-kubernetes-operator/releases/tag/v4.3.12) pages).
