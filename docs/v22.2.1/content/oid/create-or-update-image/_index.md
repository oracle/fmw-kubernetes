...
1. Edit the `<workdir>/imagetool-setup/docker-images/OracleInternetDirectory/imagetool/12.2.1.4.0/buildArgs` file and append the product patches and opatch patch as follows:
