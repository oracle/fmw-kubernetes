...
The installation binaries and patches required for release 24.1.2 are:
...
* Fusion Middleware Infrastructure patches:
    ...
    * p36155700_122140_Generic.zip (WLS PATCH SET UPDATE 12.2.1.4.240104)
    * p36086980_122140_Generic.zip (FMW Thirdparty Bundle Patch 12.2.1.4.231207)
    ...
    * p36074941_122140_Generic.zip (ADF BUNDLE PATCH 12.2.1.4.231205)
    * p36068046_122140_Generic.zip (Coherence 12.2.1.4 Cumulative Patch 20 (12.2.1.4.20))
    ...
    * p35922290_122140_Generic.zip (RDA release 24.1-20240116 for FMW 12.2.1.4.0)
    * p36034300_122140_Generic.zip (WebCenter Core Bundle Patch 12.2.1.4.231120 )
...
* Oracle SOA Suite and Oracle Service Bus patches
    * p36038320_122140_Generic.zip (SOA Bundle Patch 12.2.1.4.231122)
    * p35950186_122140_Generic.zip (OSB BUNDLE PATCH 12.2.1.4.231026)
...
1. Add a JDK package to the WebLogic Image Tool cache:
    ...
    ``` bash
    $ imagetool cache addInstaller --type jdk --version 8u401 --path <download location>/jdk-8u401-linux-x64.tar.gz
    ```
...
1. Add the downloaded product patches to the WebLogic Image Tool cache:  
    ...
    $ imagetool cache addEntry --key 35922290_12.2.1.4.0 --value <download location>/p35922290_122140_Generic.zip
...
1. Create the Oracle SOA Suite image:
    ...
    # Update OPatch and apply WebLogic patches
        COPY --chown=oracle:root p28186730_1394214_Generic.zip /tmp/imagetool/opatch/
        RUN cd /tmp/imagetool/opatch \
        && /u01/jdk/bin/jar -xf /tmp/imagetool/opatch/p28186730_1394214_Generic.zip \
...
1. Provide the following arguments to the WebLogic Image Tool `update` command:
    ...
    * `--tag` - Specify the new tag to be applied for the image being built.
    ...
    $ imagetool update --fromImage soasuite:12.2.1.4 --chown oracle:root --tag=soasuite:12.2.1.4-30761841 --patches=30761841_12.2.1.4.0 --opatchBugNumber=28186730_13.9.4.2.14
      ...
      [INFO   ] Using patch 28186730_13.9.4.2.14 from cache: <downloaded-patches-location>/p28186730_1394214_Generic.zip
