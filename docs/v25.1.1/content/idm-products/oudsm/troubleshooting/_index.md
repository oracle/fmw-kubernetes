...
Containers:
  oudsm:
    ...
    Image:          container-registry.oracle.com/middleware/oudsm_cpu:12.2.1.4-jdk8-ol8-<January'25>
...
Events:
  ...
  Normal   Pulled            39m   kubelet            Container image "container-registry.oracle.com/middleware/oudsm_cpu:12.2.1.4-jdk8-ol8-<January'25>" already present on machine
