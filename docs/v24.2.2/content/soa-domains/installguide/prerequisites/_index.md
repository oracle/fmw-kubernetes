...
Release 24.2.2 has the following system requirements:
...
* WebLogic Kubernetes Operator 4.2.2 (see the [operator releases 4.2.2](https://github.com/oracle/weblogic-kubernetes-operator/releases/tag/v4.2.2) pages).
