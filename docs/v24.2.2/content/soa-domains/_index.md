...
The current production release for the Oracle SOA Suite domains deployment on Kubernetes is [24.2.2](https://github.com/oracle/fmw-kubernetes/releases). This release uses the WebLogic Kubernetes Operator version [4.2.2](https://github.com/oracle/weblogic-kubernetes-operator/releases/tag/v4.2.2).
