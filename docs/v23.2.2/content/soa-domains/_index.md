...
The current production release for the Oracle SOA Suite domains deployment on Kubernetes is [23.2.2](https://github.com/oracle/fmw-kubernetes/releases). This release uses the WebLogic Kubernetes Operator version [4.0.6](https://github.com/oracle/weblogic-kubernetes-operator/releases/tag/v4.0.6).
