...
* Fusion Middleware Infrastructure patches:  
    * p28186730_139427_Generic.zip  (OPATCH 13.9.4.2.7 FOR EM 13.4, 13.5 AND FMW/WLS 12.2.1.3.0, 12.2.1.4.0 AND 14.1.1.0.0)
    * p33416868_122140_Generic.zip  (WLS PATCH SET UPDATE 12.2.1.4.210930)
    ...
    * p33313802_122140_Generic.zip  (ADF BUNDLE PATCH 12.2.1.4.210903)
    * p33286160_122140_Generic.zip  (Coherence 12.2.1.4 Cumulative Patch 11 (12.2.1.4.11))
...
* Oracle SOA Suite and Oracle Service Bus patches  
    * p33408307_122140_Generic.zip  (SOA BUNDLE PATCH 12.2.1.4.210928)
...
1. Add a JDK package to the WebLogic Image Tool cache:
    ...
    ``` bash
    $ imagetool cache addInstaller --type jdk --version 8u311 --path <download location>/jdk-8u311-linux-x64.tar.gz
    ```
