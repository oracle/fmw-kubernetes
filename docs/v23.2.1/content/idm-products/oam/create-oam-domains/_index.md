...
1. Edit the `create-domain-inputs.yaml` and modify the following parameters. Save the file when complete:   
   ...
   image: container-registry.oracle.com/middleware/oam_cpu:12.2.1.4-jdk8-ol7-<April`23>
...
generated artifacts:
   ...
   export image="container-registry.oracle.com/middleware/oam_cpu:12.2.1.4-jdk8-ol7-<April`23>"
...
1. Run the following command to describe the domain: 
   ...
   Metadata:
     ...
     Managed Fields:
       ...
       Operation:       Update
       Time:            <DATE>
     Resource Version:  141884
     UID:               b85571f1-f39d-4188-acfd-9264e5b925b5
   Spec:
     Admin Server:
     ...
     Image:                           container-registry.oracle.com/middleware/oam_cpu:<April`23>
