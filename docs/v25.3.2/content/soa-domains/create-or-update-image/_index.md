...
The installation binaries and patches required for release 25.3.2 are:
...
* Fusion Middleware Infrastructure patches:
    ...
    * p28186730_1394220_Generic.zip (OPATCH 13.9.4.2.20 FOR EM 13.5 AND FMW/WLS 12.2.1.4.0, 14.1.1.0.0, 14.1.2.0.0)
    * p38073767_122140_Generic.zip (OWSM BUNDLE PATCH 12.2.1.4.250613)
    * p38015786_122140_Generic.zip (ADF BUNDLE PATCH 12.2.1.4.250530)
    * p38156117_122140_Generic.zip (WLS PATCH SET UPDATE 12.2.1.4.250706)
    ...
    * p38018956_122140_Generic.zip (Coherence 12.2.1.4 Cumulative Patch 26 (12.2.1.4.26))
    ...
    * p37887285_122140_Generic.zip (RDA release 25.3-2025715 for FMW 12.2.1.4.0)
    * p37925688_122140_Generic.zip (JDBC19.27 BUNDLE PATCH 12.2.1.4.250514)
    * p38108218_122140_Generic.zip (FMW Thirdparty Bundle Patch 12.2.1.4.250623)
    * p38042142_122140_Generic.zip (OSS 19C BUNDLE PATCH 12.2.1.4.250606)
    * p34065178_122140_Generic.zip (OVD One Off)

* Oracle SOA Suite and Oracle Service Bus patches

    * p38154985_122140_Generic.zip (SOA Bundle Patch 12.2.1.4.250704)
    * p38059281_122140_Generic.zip (OSB BUNDLE PATCH 12.2.1.4.250611)
    * p38163380_122140_Generic.zip (SOA Stack Patch Bundle 12.2.1.4.250708)
...
1. Add a JDK package to the WebLogic Image Tool cache:
    ...
    ``` bash
    $ imagetool cache addInstaller --type jdk --version 8u461 --path <download location>/jdk-8u461-linux-x64.tar.gz
    ```
...
1. Add the downloaded OPatch patch to the WebLogic Image Tool cache:
    ...
    ``` bash
    $ imagetool cache addEntry --key 28186730_13.9.4.2.20 --value <download location>/p28186730_1394220_Generic.zip
    ```

1. Append the `--opatchBugNumber` flag and the OPatch patch key to the `create` command in the `buildArgs` file:

    ``` bash
    --opatchBugNumber 28186730_13.9.4.2.20
    ```
...
1. Add the downloaded product patches to the WebLogic Image Tool cache:  
    ...
    ``` bash   
        ...
        $ imagetool cache addEntry --key 38015786_12.2.1.4.0 --value <download location>/38015786_122140_Generic.zip
		
        $ imagetool cache addEntry --key 38156117_12.2.1.4.0 --value <download location>/38156117_122140_Generic.zip
	...
	$ imagetool cache addEntry --key 38018956_12.2.1.4.0 --value <download location>/38018956_122140_Generic.zip
	...
	$ imagetool cache addEntry --key 37284722_12.2.1.4.0 --value <download location>/37284722_122140_Generic.zip
	...
	$ imagetool cache addEntry --key 37887285_12.2.1.4.0 --value <download location>/37887285_122140_Generic.zip
        
	$ imagetool cache addEntry --key 37925688_12.2.1.4.0 --value <download location>/37925688_122140_Generic.zip
        
	$ imagetool cache addEntry --key 38108218_12.2.1.4.0 --value <download location>/38108218_122140_Generic.zip
        
	$ imagetool cache addEntry --key 38042142_12.2.1.4.0 --value <download location>/38042142_122140_Generic.zip
        
	$ imagetool cache addEntry --key 34065178_12.2.1.4.0 --value <download location>/34065178_122140_Generic.zip
        
	$ imagetool cache addEntry --key 38154985_12.2.1.4.0 --value <download location>/38154985_122140_Generic.zip
        
	$ imagetool cache addEntry --key 38059281_12.2.1.4.0 --value <download location>/38059281_122140_Generic.zip
        
	$ imagetool cache addEntry --key 38163380_12.2.1.4.0 --value <download location>/38163380_122140_Generic.zip
...
1. Append the `--patches` flag and the product patch keys to the `create` command in the `buildArgs` file. The `--patches` list must be a comma-separated collection of patch `--key` values used in the `imagetool cache addEntry` commands above.
   ...
   Sample `--patches` list for the product patches added in to the cache:
      ...
      ```
      --patches 38073767_12.2.1.4.0,38015786_12.2.1.4.0,38156117_12.2.1.4.0,34809489_12.2.1.4.0,36789759_12.2.1.4.0,36316422_12.2.1.4.0,38018956_12.2.1.4.0,37056593_12.2.1.4.0,36426672_12.2.1.4.0,33093748_12.2.1.4.0,37284722_12.2.1.4.0,36946553_12.2.1.4.0,34765492_12.2.1.4.0,34542329_12.2.1.4.0,35965629_12.2.1.4.0,37887285_12.2.1.4.0,37925688_12.2.1.4.0,38108218_12.2.1.4.0,38042142_12.2.1.4.0,34065178_12.2.1.4.0,38154985_12.2.1.4.0,38059281_12.2.1.4.0,38163380_12.2.1.4.0,33404495_12.2.1.4.0,32827327_12.2.1.4.0,31713053_12.2.1.4.0 
      ```
...
1. Create the Oracle SOA Suite image:
    ...
    COPY --chown=oracle:root jdk-8u461-linux-x64.tar.gz /tmp/imagetool/

    USER oracle


    RUN tar xzf /tmp/imagetool/jdk-8u461-linux-x64.tar.gz -C /u01 \
...
1. Provide the following arguments to the WebLogic Image Tool `update` command:
    ...
    * `--tag` - Specify the new tag to be applied for the image being built.
    ...
    $ imagetool update --fromImage soasuite:12.2.1.4 --chown oracle:root --tag=soasuite:12.2.1.4-30761841 --patches=30761841_12.2.1.4.0 --opatchBugNumber=28186730_13.9.4.2.20
      ...
      [INFO   ] Using patch 28186730_13.9.4.2.20 from cache: <downloaded-patches-location>/p28186730_1394220_Generic.zip
    ...
    [INFO ] Using patch 28186730_13.9.4.2.20 from cache: <downloaded-patches-location>/p28186730_1394216_Generic.zip
    [WARNING] skipping patch conflict check, no support credentials provided
    [WARNING] No credentials provided, skipping validation of patches
    [INFO ] Using patch 30761841_12.2.1.4.0 from cache: <downloaded-patches-location>/p30761841_122140_Generic.zip
