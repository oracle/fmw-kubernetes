...
If you have a single WebLogic Kubernetes Operator per Kubernetes cluster (most common use case), you can upgrade directly from any 3.x operator release to 4.2.19. The Helm chart for 4.2.19 automatically installs the schema conversion webhook.
