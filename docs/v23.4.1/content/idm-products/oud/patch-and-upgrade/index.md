...
The instructions below are for upgrading from July 22 ([22.3.1](https://github.com/oracle/fmw-kubernetes/releases)) to October 23 ([23.4.1](https://github.com/oracle/fmw-kubernetes/releases)).
