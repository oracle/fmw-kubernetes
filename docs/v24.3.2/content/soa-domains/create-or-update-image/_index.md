...
The installation binaries and patches required for release 24.3.2 are:
...
* Fusion Middleware Infrastructure patches:
    * p28186730_1394216_Generic.zip (OPATCH 13.9.4.2.15 FOR EM 13.5 AND FMW/WLS 12.2.1.4.0 AND 14.1.1.0.0)
    * p36805124_122140_Generic.zip (WLS PATCH SET UPDATE 12.2.1.4.240704)
    * p36770738_122140_Generic.zip (FMW Thirdparty Bundle Patch 12.2.1.4.240625)
    * p36316422_122140_Generic.zip (OPSS BUNDLE PATCH 12.2.1.4.240220)
    * p36769312_122140_Generic.zip (OWSM BUNDLE PATCH 12.2.1.4.240625)
    * p36700543_122140_Generic.zip (ADF BUNDLE PATCH 12.2.1.4.240605)
    * p36725924_122140_Generic.zip (Coherence 12.2.1.4 Cumulative Patch 21 (12.2.1.4.22))
    ...
    * p36553894_122140_Generic.zip (RDA release 24.3-2024716 for FMW 12.2.1.4.0)
    * p36741053_122140_Generic.zip (WebCenter Core Bundle Patch 12.2.1.4.240617 )
...
* Oracle SOA Suite and Oracle Service Bus patches
    * p36697785_122140_Generic.zip (SOA Bundle Patch 12.2.1.4.240605)
    * p36623648_122140_Generic.zip (OSB BUNDLE PATCH 12.2.1.4.231515)
...
1. Add the downloaded OPatch patch to the WebLogic Image Tool cache:
    ...
    ``` bash
    $ imagetool cache addEntry --key 28186730_13.9.4.2.15 --value <download location>/p28186730_1394216_Generic.zip
    ```

1. Append the `--opatchBugNumber` flag and the OPatch patch key to the `create` command in the `buildArgs` file:

    ``` bash
    --opatchBugNumber 28186730_13.9.4.2.16
    ```

1. Add the downloaded product patches to the WebLogic Image Tool cache:  

    ``` bash    
    $ imagetool cache addEntry --key 32808126_12.2.1.4.0 --value <download location>/p32808126_122140_Linux-x86-64.zip
    ...
    $ imagetool cache addEntry --key 36805124_12.2.1.4.0 --value <download location>/p36805124_122140_Generic.zip

    $ imagetool cache addEntry --key 36700543_12.2.1.4.0 --value <download location>/p36700543_122140_Generic.zip
    ...
    $ imagetool cache addEntry --key 36623648_12.2.1.4.0 --value <download location>/p36623648_122140_Generic.zip

    $ imagetool cache addEntry --key 34065178_12.2.1.4.0 --value <download location>/p34065178_122140_Generic.zip

    $ imagetool cache addEntry --key 36769312_12.2.1.4.0 --value <download location>/p36769312_122140_Generic.zip

    $ imagetool cache addEntry --key 34542329_12.2.1.4.0 --value <download location>/p34542329_122140_Generic.zip

    $ imagetool cache addEntry --key 36725924_12.2.1.4.0 --value <download location>/p36725924_122140_Generic.zip

    $ imagetool cache addEntry --key 33404495_12.2.1.4.0 --value <download location>/p33404495_122140_Generic.zip

    $ imagetool cache addEntry --key 36770738_12.2.1.4.0 --value <download location>/p36770738_122140_Generic.zip

    $ imagetool cache addEntry --key 33093748_12.2.1.4.0 --value <download location>/p33093748_122140_Generic.zip

    $ imagetool cache addEntry --key 36553894_12.2.1.4.0 --value <download location>/p36553894_122140_Linux-x86-64.zip

    $ imagetool cache addEntry --key 36426672_12.2.1.4.0 --value <download location>/p36426672_122140_Generic.zip

    $ imagetool cache addEntry --key 36741053_12.2.1.4.0 --value <download location>/p36741053_122140_Generic.zip

    $ imagetool cache addEntry --key 31713053_12.2.1.4.0 --value <download location>/p31713053_122140_Generic.zip

    $ imagetool cache addEntry --key 36697785_12.2.1.4.0 --value <download location>/p36697785_122140_Generic.zip
...
1. Append the `--patches` flag and the product patch keys to the `create` command in the `buildArgs` file. The `--patches` list must be a comma-separated collection of patch `--key` values used in the `imagetool cache addEntry` commands above.
   ...
   Sample `--patches` list for the product patches added in to the cache:
      ...
      ```
      --patches 32808126_12.2.1.4.0,32720458_12.2.1.4.0,32827327_12.2.1.4.0,36805124_12.2.1.4.0,36700543_12.2.1.4.0,35965629_12.2.1.4.0,36316422_12.2.1.4.0,36623648_12.2.1.4.0,34065178_12.2.1.4.0,36769312_12.2.1.4.0,34542329_12.2.1.4.0,36725924_12.2.1.4.0,33404495_12.2.1.4.0,36770738_12.2.1.4.0,33093748_12.2.1.4.0,36553894_12.2.1.4.0,36426672_12.2.1.4.0,36741053_12.2.1.4.0,31713053_12.2.1.4.0,36697785_12.2.1.4.0,34765492_12.2.1.4.0,34809489_12.2.1.4.0
      ```
...
1. Create the Oracle SOA Suite image:
    ...
    # Update OPatch and apply WebLogic patches
        COPY --chown=oracle:root p28186730_1394216_Generic.zip /tmp/imagetool/opatch/
...
1. Enter the following command to add the OPatch patch to the WebLogic Image Tool cache:
   ...
   ```bash
   $ imagetool cache addEntry --key 28186730_13.9.4.2.16 --value <download location>/p28186730_1394214_Generic.zip
   ```
...
1. Provide the following arguments to the WebLogic Image Tool `update` command:
    ...
    * `--tag` - Specify the new tag to be applied for the image being built.
    ...
    $ imagetool update --fromImage soasuite:12.2.1.4 --chown oracle:root --tag=soasuite:12.2.1.4-30761841 --patches=30761841_12.2.1.4.0 --opatchBugNumber=28186730_13.9.4.2.16
      ...
      [INFO   ] Using patch 28186730_13.9.4.2.14 from cache: <downloaded-patches-location>/p28186730_1394216_Generic.zip
      ...
      OPatch succeeded.
      Oracle Interim Patch Installer version 13.9.4.2.16
      Copyright (c) 2020, Oracle Corporation.  All rights reserved.
    ...
    $ imagetool update --fromImage soasuite:12.2.1.4 --chown oracle:root --tag=soasuite:12.2.1.4-30761841 --patches=30761841_12.2.1.4.0 --opatchBugNumber=28186730_13.9.4.2.14 --dryRun
    ...
    [INFO ] Using patch 28186730_13.9.4.2.16 from cache: <downloaded-patches-location>/p28186730_1394216_Generic.zip
    [WARNING] skipping patch conflict check, no support credentials provided
    [WARNING] No credentials provided, skipping validation of patches
    [INFO ] Using patch 30761841_12.2.1.4.0 from cache: <downloaded-patches-location>/p30761841_122140_Generic.zip
