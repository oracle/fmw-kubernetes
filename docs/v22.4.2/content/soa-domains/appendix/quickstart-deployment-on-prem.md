...
```shell
   ...
   --namespace opns \
   --set image=oracle/weblogic-kubernetes-operator:3.4.4 \
...
The WebLogic Kubernetes Operator v3.4.4 has been installed. Continue with the load balancer and Oracle SOA Suite domain setup.
