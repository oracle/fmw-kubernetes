...
Release 25.2.2 has the following system requirements:
...
* WebLogic Kubernetes Operator 4.2.15 (see the [operator releases 4.2.15](https://github.com/oracle/weblogic-kubernetes-operator/releases/tag/v4.2.15) pages).
