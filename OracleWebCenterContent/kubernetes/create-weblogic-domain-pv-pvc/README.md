...
```
$ ${KUBERNETES_CLI:-kubectl} create -f wccinfra-domain-pv.yaml
$ ${KUBERNETES_CLI:-kubectl} create -f wccinfra-domain-pvc.yaml
...
The content of the generated `wccinfra-domain-pvc.yaml`:
...
The content of the generated `wccinfra-domain-pv.yaml`:
```
# Copyright (c) 2020, 2021, Oracle and/or its affiliates.
# Licensed under the Universal Permissive License v 1.0 as shown at https://oss.oracle.com/licenses/upl.
#
...
```
$ ${KUBERNETES_CLI:-kubectl} describe pv wccinfra-domain-pv
Name:            wccinfra-domain-pv
...
```
$ ${KUBERNETES_CLI:-kubectl} describe pvc wccinfra-domain-pvc
Name:          wccinfra-domain-pvc
Namespace:     default
StorageClass:  wccinfra-domain-storage-class
Status:        Bound
