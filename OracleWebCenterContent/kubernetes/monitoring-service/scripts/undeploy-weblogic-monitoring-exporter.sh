...
InputParameterList="${InputParameterList} -ibrClusterName ${ibrClusterName} -wlsMonitoringExporterToibrCluster ${wlsMonitoringExporterToibrCluster}"
InputParameterList="${InputParameterList} -ucmClusterName ${ucmClusterName} -wlsMonitoringExporterToucmCluster ${wlsMonitoringExporterToucmCluster}"
InputParameterList="${InputParameterList} -ipmClusterName ${ipmClusterName} -wlsMonitoringExporterToipmCluster ${wlsMonitoringExporterToipmCluster}"
InputParameterList="${InputParameterList} -captureClusterName ${captureClusterName} -wlsMonitoringExporterTocaptureCluster ${wlsMonitoringExporterTocaptureCluster}"
InputParameterList="${InputParameterList} -wccadfClusterName ${wccadfClusterName} -wlsMonitoringExporterTowccadfCluster ${wlsMonitoringExporterTowccadfCluster}"
