...
if 'true' == wlsMonitoringExporterToibrCluster:
  newDeploy('wls-exporter-ibr',ibrClusterName)

if 'true' == wlsMonitoringExporterToucmCluster:
  newDeploy('wls-exporter-ucm',ucmClusterName)

if 'true' == wlsMonitoringExporterToipmCluster:
  newDeploy('wls-exporter-ipm',ipmClusterName)

if 'true' == wlsMonitoringExporterTocaptureCluster:
  newDeploy('wls-exporter-capture',captureClusterName)

if 'true' == wlsMonitoringExporterTowccadfCluster:
  newDeploy('wls-exporter-wccadf',wccadfClusterName)
